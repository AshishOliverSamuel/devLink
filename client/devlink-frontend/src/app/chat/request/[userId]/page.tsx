      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <section className="mt-6">
          ...
          <textarea
            ...
            className="w-full min-h-[160px] rounded-lg bg-[#192633] border border-slate-700 p-4 outline-none focus:ring-2 focus:ring-primary"
          />
        </section>
        ...
        <motion.div className="mt-8">
          <button
            ...
            onClick={sendRequest}
            className="w-full h-14 rounded-lg bg-primary text-white font-bold flex items-center justify-center gap-2 hover:bg-primary/90 active:scale-[0.98] disabled:opacity-60"
          >
